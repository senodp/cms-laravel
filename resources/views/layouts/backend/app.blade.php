  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item dropdown-footer text-left">Profile</a>
            <a href="#" class="dropdown-item dropdown-footer text-left">Changes Password</a>
            <a href="#" class="dropdown-item dropdown-footer text-left">Settings</a>
